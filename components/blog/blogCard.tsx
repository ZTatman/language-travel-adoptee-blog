...
export default function BlogCard({ post }: Props) {
  return (
    <ClientSideRoute  route={`/post/${post.slug.current}`} key={post._id}>
      <Card
        className="group mx-auto my-0 h-full w-full max-w-xs cursor-pointer overflow-hidden shadow-lg"
      >
        ...
        <CardContent className="space-y-3 p-4">
          <CardTitle className="font-heading text-xl line-clamp-1 group-hover:text-sky-500">
            {post.title}
          </CardTitle>
